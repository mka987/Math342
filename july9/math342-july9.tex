...
\noindent{\bf Question 5.} Show there are infinitely many primes of the
following forms
\begin{enumerate*}[{\bf (a)}]
\item $8k+3$,
\item $8k+5$, and
...
\noindent{\bf Question 6.} Show the following.
\begin{enumerate*}[{\bf (a)}]
...
\noindent{\bf Question 7.} Determine those primes for which 7 is a quadratic
residue. \\

Let $a$ and $n$ be positive integers, and let $n=p_1^{e_1} \cdots p_k^{e_k}$ be
the prime power factorization of $n$. The Jocabi symbol is defined as $(a \mid
n) = (a \mid p_1)^{e_1} \cdots (a \mid p_k)^{e_k}$. \\

\noindent{\bf Question 8.} Prove the following properties of the Jacobi symbol.
\begin{enumerate*}[{\bf (a)}]
...
\noindent{\bf Question 9.} Prove quadratic reciprocity holds for the Jacobi
